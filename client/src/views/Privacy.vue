<template>
  <div class="privacy-view">
    ...
    <p>Effective May 1st, 2019</p>
    <p>
      The Good Place Inc. ("us", "we", or "our") operates https://meandts.com (the "Site"). This page informs you of our policies regarding the collection, use and disclosure of Personal Information
    ...
    <p>
      This Log Data may include information such as your computer's Internet Protocol ("IP") address, browser type, browser version, the pages of our Site that you visit, the time and date of your
      visit, the time spent on those pages and other statistics.
    </p>
    <p>In addition, we may use third party services such as Google Analytics that collect, monitor and analyze user behavior.</p>
    ...
    <p>
      ...
      to the Privacy Policy on this page will constitute your acknowledgment of the modifications and your consent to abide and be bound by the modified Privacy Policy.
    </p>
